...
- **Drift conocido**: `999_FULL_SETUP.sql` NO incluye 015 (flags extra) ni 016 (storage) y su header está desactualizado — en DB existente correr 011→017 en orden; en DB fresca pegar 999 y después 015+016.
